...
namespace VContainer.Unity
{
    public sealed class VContainerSettings : ScriptableObject
    {
        ...
        static Plagins.VContainer.Runtime.Unity.LifetimeScope rootLifetimeScopeInstance;

        [SerializeField]
        [Tooltip("Set the Prefab to be the parent of the entire Project.")]
        public Plagins.VContainer.Runtime.Unity.LifetimeScope RootLifetimeScope;
        ...
        public Plagins.VContainer.Runtime.Unity.LifetimeScope GetOrCreateRootLifetimeScopeInstance()
        {
        ...
        public bool IsRootLifetimeScopeInstance(Plagins.VContainer.Runtime.Unity.LifetimeScope lifetimeScope) =>
