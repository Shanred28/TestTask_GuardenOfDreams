...
namespace VContainer.Unity
{
    public static class ObjectResolverUnityExtensions
    {
        ...
        public static T Instantiate<T>(
            ...
            where T : Component
        {
            if (resolver.ApplicationOrigin is Plagins.VContainer.Runtime.Unity.LifetimeScope scope)
            {
        ...
        static T Instantiate<T>(this Plagins.VContainer.Runtime.Unity.LifetimeScope scope, T prefab, Vector3 position, Quaternion rotation)
            where T : Component
        {
            var wasActive = prefab.gameObject.activeSelf;
            prefab.gameObject.SetActive(false);
        ...
        static GameObject Instantiate(this Plagins.VContainer.Runtime.Unity.LifetimeScope scope, GameObject prefab, Vector3 position, Quaternion rotation)
        {
